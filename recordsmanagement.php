...
<div class="mycontainer">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 style="color: #ffffff;" class="m-0">Records Management</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <p> Registration Requirements: knowledge of file handling</p>
                    </div>
                    <div class="card-body">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"> More About Data Analysis </h5>
